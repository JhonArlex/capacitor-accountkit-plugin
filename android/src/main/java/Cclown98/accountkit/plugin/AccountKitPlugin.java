package Cclown98.accountkit.plugin;
...
public class AccountKitPlugin extends Plugin {
    ...
    private static final String LOGIN_WITH_PHONE_NUMBER = "loginWithPhoneNumber";
    private static final String LOGIN_WITH_EMAIL = "loginWithEmail";
    ...
    public void load() {
        ...
        AccountKit.initialize(this.getActivity().getApplicationContext(), new AccountKit.InitializeCallback() {
            @Override
